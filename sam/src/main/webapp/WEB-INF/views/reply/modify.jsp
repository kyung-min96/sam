...
<section>
	<form action="/reply/modify" method="post">
		...
		<ul class="list">
			<li><label>댓글 작성자</label> <input type="text" name="writer" readonly="readonly" value="${reply.writer}"></li>
			<li><label>댓글 내용</label> <textarea rows="5" cols="50" name="content" id="contents">${reply.content}</textarea></li>
